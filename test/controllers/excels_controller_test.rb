...
class ExcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create excel" do
    assert_difference('Excel.count') do
      post excels_url, params: { excel: { analytical_type: @excel.analytical_type, no_of_samples: @excel.no_of_samples, no_of_treatments: @excel.no_of_treatments } }
    end
  ...
  test "should update excel" do
    patch excel_url(@excel), params: { excel: { analytical_type: @excel.analytical_type, no_of_samples: @excel.no_of_samples, no_of_treatments: @excel.no_of_treatments } }
